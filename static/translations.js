(function () {
    ...
    var TRANSLATIONS = {
        en: {
            ...
            deleteBtn: "Delete",
            backBtn: "← Back",
            deleteConfirm: "Delete this job and all its runs/thumbnails from disk? This cannot be undone.",
            jobStats: "shots",
            runsTitle: "Runs",
            runLabel: "Run",
            ...
            sourceMissing: "Source video is missing on disk - reprocess is unavailable.",
        ...
        zh: {
            ...
            deleteBtn: "刪除",
            backBtn: "← 返回",
            deleteConfirm: "確定從磁碟刪除此任務與所有執行檔／縮圖？此動作無法復原。",
            jobStats: "個鏡頭",
            runsTitle: "執行紀錄",
            runLabel: "執行",
            currentBadge: "目前",
